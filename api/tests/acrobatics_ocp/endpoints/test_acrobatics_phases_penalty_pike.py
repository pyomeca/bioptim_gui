...
@pytest.mark.parametrize(
    ...
    [
        (2, [0, 0], [6, 5, 5, 6, 6], [0, 2, 0, 0, 0, 0]),
        (2, [0, 1], [6, 5, 5, 4, 6], [0, 2, 0, 0, 0]),
        (2, [1, 0], [4, 6, 5, 5, 6, 6], [0, 0, 2, 0, 0, 0]),
        (2, [1, 1], [4, 6, 5, 5, 4, 6], [0, 0, 2, 0, 0, 0]),
        (3, [0, 0, 0], [6, 5, 5, 6, 6], [0, 2, 0, 0, 0]),
        (3, [0, 0, 1], [6, 5, 5, 4, 6], [0, 2, 0, 0, 0]),
        (3, [0, 1, 0], [6, 5, 5, 4, 6, 5, 5, 6, 6], [0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (3, [0, 1, 1], [6, 5, 5, 4, 6, 5, 5, 4, 6], [0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (3, [1, 0, 0], [4, 6, 5, 5, 6, 6], [0, 0, 2, 0, 0, 0]),
        (3, [1, 0, 1], [4, 6, 5, 5, 4, 6], [0, 0, 2, 0, 0, 0]),
        (3, [1, 1, 0], [4, 6, 5, 5, 4, 6, 5, 5, 6, 6], [0, 0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (3, [1, 1, 1], [4, 6, 5, 5, 4, 6, 5, 5, 4, 6], [0, 0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (4, [0, 0, 0, 0], [6, 5, 5, 6, 6], [0, 2, 0, 0, 0]),
        (
            4,
            [1, 0, 1, 0],
            [4, 6, 5, 5, 4, 6, 5, 5, 6, 6],
        ...
        (4, [0, 1, 0, 1], [6, 5, 5, 4, 6, 5, 5, 4, 6], [0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (
            4,
            [1, 1, 1, 1],
            [4, 6, 5, 5, 4, 6, 5, 5, 4, 6, 5, 5, 4, 6],
