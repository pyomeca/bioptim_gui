...
@pytest.mark.parametrize(
    ...
    [
        (2, [0, 0], [5, 5, 4, 3, 6], [0, 2, 0, 0, 0, 0]),
        (2, [0, 1], [5, 5, 4, 4, 6], [0, 2, 0, 0, 0]),
        (2, [1, 0], [4, 5, 5, 4, 3, 6], [0, 0, 2, 0, 0, 0]),
        (2, [1, 1], [4, 5, 5, 4, 4, 6], [0, 0, 2, 0, 0, 0]),
        (3, [0, 0, 0], [5, 5, 4, 3, 6], [0, 2, 0, 0, 0]),
        (3, [0, 0, 1], [5, 5, 4, 4, 6], [0, 2, 0, 0, 0]),
        (3, [0, 1, 0], [5, 5, 4, 4, 5, 5, 4, 3, 6], [0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (3, [0, 1, 1], [5, 5, 4, 4, 5, 5, 4, 4, 6], [0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (3, [1, 0, 0], [4, 5, 5, 4, 3, 6], [0, 0, 2, 0, 0, 0]),
        (3, [1, 0, 1], [4, 5, 5, 4, 4, 6], [0, 0, 2, 0, 0, 0]),
        (3, [1, 1, 0], [4, 5, 5, 4, 4, 5, 5, 4, 3, 6], [0, 0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (3, [1, 1, 1], [4, 5, 5, 4, 4, 5, 5, 4, 4, 6], [0, 0, 2, 0, 0, 0, 2, 0, 0, 0]),
        (4, [0, 0, 0, 0], [5, 5, 4, 3, 6], [0, 2, 0, 0, 0]),
        (
            4,
            [1, 0, 1, 0],
            [4, 5, 5, 4, 4, 5, 5, 4, 3, 6],
