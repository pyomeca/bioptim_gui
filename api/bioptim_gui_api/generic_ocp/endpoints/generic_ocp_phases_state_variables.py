...
def put_state_variable_dimensions(phase_index: int, variable_index: int, dimension: DimensionRequest):
...
@router.put("/{phase_index}/state_variables/{variable_index}/initial_guess_interpolation_type")
...
def put_state_variables_max_bounds_value(phase_index: int, variable_index: int, value: VariableUpdateRequest):
    phases_info = read_generic_ocp_data("phases_info")
...
def put_state_variables_min_bounds_value(phase_index: int, variable_index: int, value: VariableUpdateRequest):
    phases_info = read_generic_ocp_data("phases_info")
    x, y, new_value = value.x, value.y, value.value
...
def put_state_variables_initial_guess_value(phase_index: int, variable_index: int, value: VariableUpdateRequest):
    phases_info = read_generic_ocp_data("phases_info")
    x, y, new_value = value.x, value.y, value.value
