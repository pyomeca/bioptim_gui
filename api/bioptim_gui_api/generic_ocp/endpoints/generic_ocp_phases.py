...
from bioptim_gui_api.generic_ocp.endpoints.generic_ocp_phases_control_variables import (
    router as control_variables_router,
)
from bioptim_gui_api.generic_ocp.endpoints.generic_ocp_phases_objectives import (
