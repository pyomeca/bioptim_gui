...
@router.put("/{phase_index}/control_variables/{variable_index}/dimension")
def put_control_variables_dimensions(phase_index: int, variable_index: int, dimension: DimensionRequest):
...
@router.put("/{phase_index}/control_variables/{variable_index}/bounds_interpolation_type")
...
@router.put("/{phase_index}/control_variables/{variable_index}/initial_guess_interpolation_type")
...
@router.put("/{phase_index}/control_variables/{variable_index}/max_bounds")
def put_control_variables_max_bounds_value(phase_index: int, variable_index: int, value: VariableUpdateRequest):
    phases_info = read_generic_ocp_data("phases_info")
...
@router.put("/{phase_index}/control_variables/{variable_index}/min_bounds")
def put_control_variables_min_bounds_value(phase_index: int, variable_index: int, value: VariableUpdateRequest):
    phases_info = read_generic_ocp_data("phases_info")
    x, y, new_value = value.x, value.y, value.value
...
@router.put("/{phase_index}/control_variables/{variable_index}/initial_guess")
def put_control_variables_initial_guess_value(phase_index: int, variable_index: int, value: VariableUpdateRequest):
    phases_info = read_generic_ocp_data("phases_info")
    x, y, new_value = value.x, value.y, value.value
