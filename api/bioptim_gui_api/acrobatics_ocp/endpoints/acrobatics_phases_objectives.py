...
def put_objective_weight_maximize(phase_index: int, objective_index: int):
    ...
    if old_weight > 0:
        phases_info[phase_index]["objectives"][objective_index]["penalty_type"] = DefaultPenaltyConfig.min_to_max(
            penalty_type
        )
...
def put_objective_weight_minimize(phase_index: int, objective_index: int):
    ...
    if old_weight < 0:
        phases_info[phase_index]["objectives"][objective_index]["penalty_type"] = DefaultPenaltyConfig.max_to_min(
            penalty_type
        )
